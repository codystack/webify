                    ...
                    <div class="col-12 col-md-7 col-lg-5 col-xl-4">
                        <div class="navbar-body">
                            ...
                            <li class="nav-item <?php if($page=='home'){echo 'active';}?>">
                                ...
                                <li class="nav-item <?php if($page=='case-study'){echo 'active';}?>">
                                    <a href="case-study" class="nav-link">
                                        <span class="nav-link-name">case study</span>
                                    </a>
                                </li>
                                <li class="nav-item <?php if($page=='how-it-works'){echo 'active';}?>">
                                ...
                                <li class="nav-item <?php if($page=='login'){echo 'active';}?>">
                                    <a href="https://app.webify.com.ng/login" class="nav-link">
                                        <span class="nav-link-name">login</span>
                                    </a>
                                </li>
                                <li class="nav-item <?php if($page=='get-started'){echo 'active';}?>">
                                    <a href="https://app.webify.com.ng/register" class="nav-link">
