                ...
                <div id="main">
                    ...
                    <div id="hero" class="has-image">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width height-title">
                                <div class="inner">   
                                    <h1 class="hero-title caption-timeline primary-font-title"><span>Pixpectiv</span></h1>
                                </div>
                            </div>
                            <div id="hero-description" class="content-full-width">
                                <div class="inner">
                                    ...
                                    <p class="has-opacity">2023</p>
                                    <p class="bigger no-margins">Scope of work</p>
                                    <p class="has-opacity no-margins">Web Development</p>
                                </div>
                            </div>
                            <div id="hero-footer">
                    ...
                    <div id="hero-image-wrapper">
                    	<div id="hero-background-layer" class="parallax-scroll-image">
                            <div id="hero-bg-image" style="background-image:url(../assets/images/hero/pixpectiv-hero.jpg)"></div>
                        </div>
                    </div>
