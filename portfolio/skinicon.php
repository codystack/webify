<?php include "../components/port-header.php"; ?>

        <div id="clapat-page-content" class="light-content" data-bgcolor="#0c0c0c">
            
            <?php include "../components/port-navbar.php"; ?>
                ...
                <div id="main">
                    ...
                    <div id="hero" class="has-image">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width height-title">
                                <div class="inner">   
                                    <h1 class="hero-title caption-timeline primary-font-title"><span>Skin Icon</span></h1>
                                </div>
                            </div>
                            <div id="hero-description" class="content-full-width">
                                <div class="inner">
                                    ...
                                    <p class="has-opacity no-margins">Branding & Web Development</p>                                                                      
                                    <hr> 
                                    <p class="has-animation">[ <a class="link-text" target="_blank" href="https://skinicon.ng/"><span class="link" data-hover="View Website">View Website</span></a> ]</p>
                                </div>
                            </div>
                            <div id="hero-footer">
                    ...
                    <div id="hero-image-wrapper">
                    	<div id="hero-background-layer" class="parallax-scroll-image">
                            <div id="hero-bg-image" style="background-image:url(../assets/images/hero/skinicon-hero.jpg)"></div>
                        </div>
                    </div>
                    ...
                    <div id="main-content">
                        ...
                        <div id="project-nav" class="">
                            <div class="next-project-wrap">
                                ...
                                <p class="all-works">
                                    <a class="link-text ajax-link" data-type="page-transition" href="projects">
