                    ...
                    <div id="hero">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width parallax-scroll-caption text-align-center height-title">
                                <div class="inner">                                    
                                    <h1 class="hero-title caption-timeline primary-font-title"><span>Bespoke</span></h1>
                                    <div class="hero-subtitle caption-timeline">
                                        <span>A tailored design & an expert team.</span>
                                        <span>All of our projects are tailor-made for our clients, <br class="destroy">with no compromise on quality at any stage of the production process.</span>
                                    </div>                                   
                                </div>
                            </div>
                            <div id="hero-footer">
