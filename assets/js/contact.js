...
---------------------------------------------------*/	
	...
	function ContactMap() {	
		...
		if( jQuery('#map_canvas').length > 0 ){					
			var latlng = new google.maps.LatLng(6.44974,3.46993);
			var settings = {
				zoom: 14,
				center: new google.maps.LatLng(6.44974,3.46993),
			...
			var companyImage = new google.maps.MarkerImage('assets/images/favicon.png',
