                ...
                <div id="main">
                            ...
                            <div id="hero-caption" class="content-full-width parallax-scroll-caption text-align-center height-title">
                                <div class="inner">                                    
                                    ...
                                    <div class="hero-subtitle caption-timeline">
                                        <span>We bring brands to life through creative <br class="destroy">solutions that are both effective and innovative – setting visual, <br class="destroy">verbal, and experiential standards that drive impactful experiences.</span>
                                    </div>                                   
                                </div>
                            </div>
                            <div id="hero-footer">
                    ...
                    <div id="main-content">
                        ...
                        <div id="main-page-content" class="content-max-width">
                            ...
                            <div class="content-row full dark-section change-header-color" data-bgcolor="#171717">
                                
                                <figure class="has-parallax has-parallax-content" data-delay="100">
                                    <img src="assets/images/design.jpg" alt="Image Title">
                                    <div class="parallax-image-content content-full-width text-align-center">
                                    	<div class="outer">
                                            <div class="inner">         
                                                <h2><span class="has-mask-fill">A tailored design</span><br><span class="has-mask-fill">& an expert team.</span></h2>                                                 
                                            </div>
                                    	</div>
                                    </div>
                                </figure>
                            ...
                            <hr><hr><hr class="animated-line has-animation"><hr><hr><hr>

                            <div class="one_third">
                                <h3 class="big-title primary-font-title no-margins has-mask-fill">About Us</h3>
                            </div>
                            

                            <div class="two_third last">
                                <h5>We bring brands to life through creative solutions that are both effective and innovative – setting visual, verbal, and experiential standards that drive impactful experiences.</h5>
                                <p>We are a boutique digital transformation, consultancy and software development company that focuses on building world-class products, providing excellent services using technology to inspire and implement solutions to enable businesses. We maximize our ability to take on any project by creating a diverse team who can bring their experience and perspectives together to solve problems.</p>
                                <p>Webify is a trademark of Contagious Agency LTD. The company which was founded in 2019, was created to harness disruptive building blocks to transform ambitious and trusted brands and our track record traces itself back to a line of clients that have dared to challenge the norm by partnering with us to re-envision what it means to start something today.</p>
                            </div>
                            ...
                            <div class="content-row row_padding_top row_padding_bottom light-section change-header-color has-clip-path" data-bgcolor="#fff">
								...
								<div class="pinned-section">
                                    <div class="pinned-element left">
                                        <h2 class="big-title primary-font-title no-margins">
                                            <span class="has-mask-fill">Our</span><br>
                                    ...
                                    <div class="scrolling-element right">
                                    	<dl class="accordion has-animation">
											<dt>
												<span class="link"><div>Web Development</div></span>
                            ...
                            <div class="page-nav-wrap">
                                <div class="page-nav-caption content-full-width text-align-center height-title">                                 
                                    <div class="inner">
                                        ...
                                        <a class="page-title next-ajax-link-page" data-type="page-transition" data-centerline="Say Hey" href="start-a-project">
                                            <div class="next-hero-title primary-font-title caption-timeline"><span>Start a Project</span></div>
                                        </a>                                        
                                    </div>               
                                </div>
                            </div>
