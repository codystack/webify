<footer class="footer bg-dark text-white shape-parent overflow-hidden py-130">
            ...
            <div class="container mb-n5">
                <div class="row justify-content-between mb-100 gh-1 gv-4">
                    <div class="col-lg-3">
                        <a href="home.html" class="d-block mb-30">
                            <img width="184" src="assets/images/logo-white.png" alt="">
                        </a>
                        <p class="mb-0">Be saying moveth spirit fruitful called set evening fly give shall moveth lesser very.</p>
                    </div>
                    <div class="d-none d-lg-block col-2"></div>
                    <div class="col-lg-6">
                        <p class="subtitle mb-30 text-muted">subscribe of newsletter</p>
                        <form action="#">
                ...
                <div class="row justify-content-between gh-1 gv-4 mb-30">
                    <div class="col-lg-3">
                        <ul class="nav flex-column text-white">
                            <li class="nav-item">
                                <a href="#" class="nav-link">+234 (0)803-209-0933</a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link">hello@webify.com.ng</a>
                            </li>
                        </ul>
                    </div>
                    <div class="d-none d-lg-block col-2"></div>
                        ...
                        <div class="row gh-1 gv-1">
                            <div class="col-12 col-lg-4">
                                <ul class="nav flex-column text-white">
                                    ...
                                    <li class="nav-item">
                                        <a href="customize" class="nav-link">Custom project</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-12 col-lg-4">
                            ...
                            <div class="col-12 col-lg-4">
                                <ul class="nav flex-column text-white">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Terms of te use</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row justify-content-between mt-100 mt-lg-0">
                    ...
                    <div class="col-auto">
                        <div class="footer-copyright">© <script>document.write(new Date().getFullYear());</script> Webify&trade; All Rights Reserved.</div>
                    </div>
                </div>
            </div>
        </footer>
